    ...
    private static synchronized void write(Context context, String event, String processSummary,
        ...
        try {
            ...
            try (PrintWriter writer = new PrintWriter(new FileOutputStream(output, true))) {
                ...
                // This is a reported setting, not a claim about a vendor's effective policy.
                try {
                    String monitor = android.provider.Settings.Global.getString(context.getContentResolver(),
                            "settings_enable_monitor_phantom_procs");
                    writer.println("Android child-process monitor setting: "
                            + (monitor == null ? "Global override unset; effective policy not verified" : monitor));
                } catch (Exception unavailable) {
                    writer.println("Android child-process monitor setting: unavailable");
                }
