 ...
 * used less than [busyTicksPerSample] since the last sample was quiet in between.
 */
internal class ActivityClock(
    ...
    fun sleepsAt(): Long = lastActivityAt + idleLimitMs

    fun isIdle(now: Long): Boolean = now >= sleepsAt()
