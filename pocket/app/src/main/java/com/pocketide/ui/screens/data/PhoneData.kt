 ...
 * GitHub sign-in (cookies and site storage), caches and settings. Nothing in the owner's GitHub
 * account is touched: repositories and cloud computers stay. Main thread (it ends the page).
 */
