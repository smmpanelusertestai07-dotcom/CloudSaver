...
#
# It used to be: .signing/pocketlinux-local.jks was committed, with its password written three
...
KEYSTORE="${POCKETLINUX_KEYSTORE:-}"
STORE_PASS="${POCKETLINUX_STORE_PASS:-}"
