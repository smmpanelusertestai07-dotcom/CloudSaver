...
`app/assets/pocketlinux-mcp.py` is PocketLinux's own work, written for this app and covered by this
...
`pocketlinux-windows.sh`, `pocketlinux-menu.sh`, `pocketlinux-desktop.sh`, `pocketlinux-open.sh` and
`pocketlinux-install.sh`: all PocketLinux's own.
