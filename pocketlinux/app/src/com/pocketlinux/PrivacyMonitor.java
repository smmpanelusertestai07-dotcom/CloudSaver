...
final class PrivacyMonitor {
    ...
    static final class Entry {
        /** The android.permission.* name, or "" for the never-asked entries. */
        ...
        Entry(String permission, String name, String purpose, boolean held, boolean runtime,
                boolean neverAsked) {
        ...
        try {
            ...
            if (declared != null) {
                for (String permission : declared) {
                    ...
                    entries.add(new Entry(permission, shortName(permission), purposeOf(permission),
                            held, isRuntime(permission), false));
                }
            }
