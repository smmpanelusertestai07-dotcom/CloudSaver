...
spec = importlib.util.spec_from_file_location('procinfo', Path(__file__).with_name('pocketlinux-procinfo.py'))
procinfo = importlib.util.module_from_spec(spec)
spec.loader.exec_module(procinfo)

spec = importlib.util.spec_from_file_location('childwatch', Path(__file__).with_name('pocketlinux-childwatch.py'))
