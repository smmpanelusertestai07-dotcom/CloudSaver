# PocketAgent 14.2.0 — Native mobile IDE
...
The build has version code **450**, targets API 35, requires API 29 and packages ARM64 native
libraries with 16 KB ZIP alignment. Output is `build/PocketAgent-v14.2.0-release.apk`,
or `build/PocketAgent-v14.2.0-devkey-release.apk` for a generated development key.
