# PocketAgent 14.2.5 — Native mobile IDE
...
The build has version code **455**, targets API 35, requires API 29 and packages ARM64 native
libraries with 16 KB ZIP alignment. Output is `build/PocketAgent-v14.2.5-release.apk`,
or `build/PocketAgent-v14.2.5-devkey-release.apk` for a generated development key.
