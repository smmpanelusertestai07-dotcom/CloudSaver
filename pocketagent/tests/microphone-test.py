...
'com/pocketagent/mobile/ContainerRuntime.java': '''package com.pocketagent.mobile;
...
'com/pocketagent/mobile/MicBridgeHarness.java': r'''package com.pocketagent.mobile;
...
class MicrophoneTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        compilation = subprocess.run(javac + ['-encoding', 'UTF-8', '-source', '8', '-target', '8', '-d', str(cls.folder)]
                       ...
                       + [str(PROJECT / 'app/src/com/pocketagent/mobile/MicBridge.java')],
    ...
    def check_case(self, case):
        result = subprocess.run([self.java, '-cp', str(self.folder), 'com.pocketagent.mobile.MicBridgeHarness', case],
