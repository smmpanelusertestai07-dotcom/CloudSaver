#!/usr/bin/env python3
"""Draws PocketAgent's own desktop icons.

The desktop borrows Adwaita for everything Ubuntu ships, but the four entries PocketAgent adds
...
def projects():
    ...
    save(image, "pocketagent-projects.png")
...
def settings():
    ...
    save(image, "pocketagent-settings.png")
...
def software():
    ...
    save(image, "pocketagent-software.png")
...
def package():
    ...
    draw.line([(s(104), s(166)), (s(128), s(190)), (s(152), s(166))], fill=WHITE,
              width=pen, joint="curve")
    save(image, "pocketagent-package.png")
...
def phone_files():
    ...
    save(image, "pocketagent-phone.png")
...
def home_files():
    ...
    image, draw = canvas()
    folder(draw, AMBER, AMBER_DEEP)
    save(image, "pocketagent-files.png")
