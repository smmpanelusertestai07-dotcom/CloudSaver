...
public final class MainActivity extends Activity {
    static final String VERSION = "14.1.5";
    ...
    private TextView versionLine(int muted) {
        TextView version = Ui.text(this, "PocketAgent " + VERSION + " · Ubuntu 24.04 LTS · works on "
    ...
    private View buildAttentionCard(int text, int muted) {
        ...
        attentionSpace = attentionRow(R.drawable.ic_storage, "Free space is low",
                "", v -> toggleDetail(attentionSpace, spaceDetail, "The Linux computer needs "
                        ...
                        + "comfortably. PocketAgent has no quota of its own — the computer grows into "
    ...
    private View buildWhyLinuxCard(int text, int muted) {
        ...
        addAnswer(card, R.drawable.ic_phone, "Google's own Linux Terminal on Android — how does this compare?",
                "Google ships a Terminal app in Android (from Android 15 QPR2 in 2025; graphical "
                        ...
                        + "PocketAgent takes the other road: no virtual machine and no special "
                        ...
                        + "Docker and everything else that needs one; PocketAgent shares the phone's "
        ...
        addAnswer(card, R.drawable.ic_check, "Every AI desktop app here ships for Linux",
                "OpenAI released the ChatGPT desktop app for Linux (with Codex) as a public preview "
                        ...
                        + "PocketAgent installs exactly those packages, from each publisher's own "
        ...
        addAnswer(card, R.drawable.ic_shield, "Safe, private, and yours",
                "Everything lives in this app's private storage on this phone: the system, the "
                        + "apps, their logins, your files. No PocketAgent account, no server, no "
    ...
    private View buildOtherAppsCard(int text, int muted) {
        ...
        card.addView(Ui.text(this,
                "In the desktop, download the app's Linux build for ARM64 (a .deb file) in Chrome "
                        + "and open it. PocketAgent's installer names the app and its publisher, "
    ...
    private LinearLayout buildSettingsPage() {
        ...
        data.addView(Ui.text(this, "Downloads stay in the private computer. Use Export or Share "
                + "to choose a destination with Android's system picker. Changing this preference "
                + "does not move existing files.", 12.5f, muted), Ui.matchWrap(this, 10));
        ...
        appLockToggle = new Ui.Toggle(this, R.drawable.ic_lock, "App lock",
                "Asks for your fingerprint or the phone's PIN right after the opening screen, and "
                        + "again whenever PocketAgent comes back to the front — the home screen and "
        ...
        privacy.addView(Ui.text(this, "The Linux workspace and saved logins use this app's private "
                + "storage; Android backup is disabled. Prompts and selected project content are "
                + "sent to the AI provider or connected service you use. Approved Linux tools share "
                + "this workspace, so install and connect only tools you trust.", 12.5f, muted),
                Ui.matchWrap(this, 10));

        // Permissions
        LinearLayout permissions = group(page, "Permissions");
        permissions.addView(Ui.text(this, "PocketAgent asks for the minimum it needs. Tap a row to change it.",
        ...
        Ui.Row backgroundRow = new Ui.Row(this, R.drawable.ic_auto_mode, "Background activity",
                "On the phone's battery page for PocketAgent, turn ON Allow foreground activity and "
        ...
        phoneFilesRow = new Ui.Row(this, R.drawable.ic_phone, "Phone files", "Picker only",
                R.drawable.ic_chevron, dark, v -> dialogBuilder()
                        .setTitle("Choose individual files")
                        .setMessage("PocketAgent does not request broad phone storage access or mount "
                                + "your phone's folders. Add file opens Android's system picker and "
                                + "copies only the files you select into the private workspace. "
                                + "Export uses a destination you choose. Existing files are not deleted.")
        ...
        permissions.addView(new Ui.Row(this, R.drawable.ic_info, "App info",
                "Android's full settings page for PocketAgent",
        ...
        TextView storageExplain = Ui.text(this,
                "PocketAgent has no size limit of its own. The computer grows into whatever this "
        ...
        TextView credits = Ui.text(this, "Runs Ubuntu 24.04 LTS on the phone's own processor. "
                ...
                + "trademark of Linus Torvalds; PocketAgent is not affiliated with either. Every "
    ...
    private void onAppLockToggled(boolean checked) {
        ...
        AppLock.prompt(this, unlocked -> {
            if (unlocked) {
                ...
                refreshLockRows();
                android.widget.Toast.makeText(this, "App lock is on: PocketAgent asks for your fingerprint "
    ...
    private View buildQuestionsCard(int text, int muted) {
        ...
        addAnswer(card, R.drawable.ic_desktop, "Why not Windows apps, or a Windows layer?",
                "Because on this hardware it cannot be done, and where it can be done it is worse "
                        + "than what is already here. PocketAgent carried a Windows compatibility "
                        ...
                        + "Windows programs to drive. PocketAgent supplies that capability itself "
        ...
        addAnswer(card, R.drawable.ic_info, "Do Mac, Windows and Linux get the same features?",
                "No, and the pattern is worth knowing before you choose anything.\n\n"
                        ...
                        + "PocketAgent answers the first two itself: appshot, and click, type, key "
        ...
        addAnswer(card, R.drawable.ic_fullscreen, "An app's text is small, or its window ran off the screen",
                "Three different dials, and it matters which one you turn.\n\n"
                        + "Settings → Desktop text size is the computer's own dpi: every program "
                        + "reads it when it starts. ChatGPT, Claude, Cursor, Antigravity and Chrome "
                        + "are all Chromium programs, and a Chromium program scales its whole "
                        + "window with it — including the smallest width it will allow, which the "
                        + "desktop cannot shrink. Past a point that width is wider than the phone, "
                        + "and the window's right-hand edge, close button included, is off the "
                        + "screen. PocketAgent caps that scale from the desktop's width as it is "
                        + "right now, so a newly opened window always fits; an app already open "
                        + "keeps the scale it started with until it is reopened.\n\n"
                        + "Screen → Bigger interface on the desktop is the viewer scaling the "
                        + "picture: it changes nothing inside the computer, and it stops at the "
                        + "step where an app window would stop fitting the screen (landscape "
                        + "allows more).\n\n"
        ...
        addAnswer(card, R.drawable.ic_desktop, "Is the desktop GNOME, KDE or Cinnamon?",
                "None of them. This desktop is a small set of standard Ubuntu parts, each doing one "
                        ...
                        + "the PocketAgent mark that shows the desktop.\n"
        ...
        addAnswer(card, R.drawable.ic_phone, "Is it all on my phone?",
                "Yes. The Linux computer and every app on it run "
                        ...
                        + "server, no PocketAgent account, no tracking or analytics of any kind. "
        ...
        addAnswer(card, R.drawable.ic_storage, "How do I attach a file from my phone to ChatGPT or Claude?",
                "Use Add file in the native workspace. Android opens its system picker, where "
                        + "you choose the files to copy into the current project. In the desktop, use "
                        + "Phone → Add a file from the phone or a cloud drive. No public phone folders "
                        + "are mounted; imported copies stay private until you choose to share them.", false);
        ...
        addAnswer(card, R.drawable.ic_lock, "Are my logins safe?",
                "When you sign in to ChatGPT or Claude inside Linux, the login is stored by that "
                        ...
                        + "this phone. Android lets no other app read it, and PocketAgent itself "
        ...
        addAnswer(card, R.drawable.ic_storage, "Where do my files go?",
                "Projects, Computer Downloads and Shared are in PocketAgent's private storage. "
                        + "Shared is private too. Use Export or Share to save a file to an Android "
                        + "destination you choose. No public phone folders are mounted.\n\n"
                        + "Older public Shared files are left where they were; this update does not "
                        + "move or delete them. Uninstalling PocketAgent removes its private files, "
                        + "so export work you want to keep first.", false);
        ...
        addAnswer(card, R.drawable.ic_shield, "Is there virus and malware protection?",
                "Yes, and it is on by default — the same layered kind a phone uses, not a "
                        ...
                        + "• Google Play Protect scans PocketAgent itself on your phone: when it is "
                        ...
                        + "checking inside the computer is PocketAgent's job, and these are it.\n"
                        + "• Anything you download and install yourself goes through PocketAgent's own "
                        ...
                        + "can open. Public phone folders are not mounted.\n\n"
        ...
        addAnswer(card, R.drawable.ic_lock, "If something bad got in, how far could it get?",
                "Linux tools run under PocketAgent's Android identity. They can access the "
                        + "private Linux workspace and its saved credentials; PRoot is a compatibility "
                        + "environment, not a security sandbox between Linux apps. Only approve tools "
                        + "and commands you trust.\n\n"
                        + "PocketAgent does not request broad phone storage access or mount public phone "
                        + "folders. Imports and exports use Android's system picker. AI requests and "
                        + "connected tools can send selected project data over the internet.\n\n"
                        + "Wireless debugging, if separately paired for phone testing, grants powerful "
                        + "ADB control. Keep it disabled when you do not need phone testing.", false);

        addAnswer(card, R.drawable.ic_download, "Can I install an app I downloaded myself?",
                "Yes — it works like tapping an APK from a website on Android, and PocketAgent "
        ...
        addAnswer(card, R.drawable.ic_shield, "What can this app touch on my phone?",
                "Its permissions are: internet, network status, notifications, running in "
                        ...
                        + "you explicitly import a copy through the system picker; otherwise the "
        ...
        addAnswer(card, R.drawable.ic_stop, "Why did an app close by itself, or the desktop go back to Home?",
                "A crash can come from the app, the desktop connection, memory pressure or an "
                        ...
                        + "PocketAgent preserves a running app during repeated taps and sign-in "
        ...
        addAnswer(card, R.drawable.ic_desktop, "Live voice, camera and screen share \u2014 what works?",
                "Voice: YES. Now that the microphone works, a live voice conversation runs in the "
                        ...
                        + "computer's Pictures folder, ready to attach. PocketAgent itself holds no "
        ...
        addAnswer(card, R.drawable.ic_volume, "Can the computer hear me? (microphone)",
                "Yes. Phone → Microphone, on the desktop screen, hands the phone's microphone to "
                        ...
                        + "storage. It is not recorded to a file, PocketAgent sends it nowhere, and "
        ...
        addAnswer(card, R.drawable.ic_desktop, "Can the AI see the screen and use the computer?",
                "Yes — PocketAgent provides that itself, because the publishers' own versions of it "
        ...
        addAnswer(card, R.drawable.ic_apps, "How many apps can I have open at once?",
                "On a 4 GB phone, start with one AI app and only the browser tabs or tools you "
                        ...
                        + "Save your work regularly. PocketAgent checks available memory before a new "
        ...
        addAnswer(card, R.drawable.ic_lock, "Do I need an account, password or lock?",
                "No account and no separate password — the Linux computer is yours, "
                        ...
                        + "opening screen when you start PocketAgent, and again each time it comes "
        ...
        addAnswer(card, R.drawable.ic_delete, "What if I uninstall PocketAgent?",
                "Android deletes the private Linux computer, saved logins and workspace files "
                        + "when PocketAgent is uninstalled. Export work you want to keep first using "
                        + "Android's system picker. Files you already exported remain at the destination "
                        + "you chose. Updating PocketAgent does not delete your existing project files.", false);
        ...
        addAnswer(card, R.drawable.ic_info, "The honest limits",
                "These are the permanent ones. This is an agentic development environment, "
                        ...
                        + "own plans and limits still apply; PocketAgent cannot change them. "
                        + "PocketAgent is provided as is: it is a computer inside an app, not a "
    ...
    private static final String[] DOWNLOAD_LABELS = {
            "Ask every time · recommended", "Computer Downloads · private"};
    ...
    private static final int[] DOWNLOAD_ICONS = {
            R.drawable.ic_download, R.drawable.ic_desktop};
    ...
    private void showPrivacyMonitor() {
        ...
        String text = "What PocketAgent holds right now\n\n" + held
                ...
                .setPositiveButton("Copy", (d, w) -> {
                    ...
                    if (board != null) {
                        board.setPrimaryClip(android.content.ClipData.newPlainText(
                                "PocketAgent error report", report));
    ...
    private void showLinuxAppReports() {
        ...
        dialogBuilder().setTitle("Linux app reports").setItems(names, (dialog, index) -> {
            ...
            final String report = "PocketAgent " + VERSION + " · " + names[index] + " (Linux)\n\n" + output;
            dialogBuilder().setTitle(names[index] + " · Linux report").setMessage(report)
                    ...
                    .setPositiveButton("Copy", (entry, which) -> {
                        ...
                        if (board != null) {
                            board.setPrimaryClip(android.content.ClipData.newPlainText(
                                    "PocketAgent Linux app report", report));
            ...
            StringBuilder combined = new StringBuilder("PocketAgent " + VERSION + " | Android "
            ...
            java.io.File folder = new java.io.File(ContainerRuntime.rootfs(this), "home/coder/.pocketagent/logs");
            ...
            if (board != null) {
                board.setPrimaryClip(android.content.ClipData.newPlainText("PocketAgent Linux reports", report));
    ...
    private void refreshPermissionRows() {
        ...
        if (phoneFilesRow != null) {
            phoneFilesRow.setStatus("PICKER ONLY", Ui.muted(dark));
            phoneFilesRow.setValue("Choose individual imports and export destinations with Android's system picker");
        }
        if (downloadTargetRow != null) downloadTargetRow.setValue(downloadTargetValue());
    ...
    private void maybeShowPermissionIntro() {
        ...
        permissionIntro = dialogBuilder()
                ...
                .setMessage("Setting up the Linux computer downloads for 10–30 minutes in the background. "
                        ...
                        + "PocketAgent (Settings → Permissions opens it).\n\n"
    ...
    private void refreshState() {
        ...
        if (running) {
            ...
            statusNote.setText((detail == null || detail.trim().isEmpty()
                    ...
                    + "on and leave PocketAgent's battery usage Unrestricted.");
        } else if (installed) {
            ...
            note += "\n\nTools → Software installs any native ARM64 Ubuntu package, and a .deb "
                    + "you downloaded yourself opens in PocketAgent's own installer.";
     ...
     * surprised: PocketAgent's own, Ubuntu's, and the AI companies'. Each paragraph below says
     * whose is whose, and nothing is padded out with the sort of sentence nobody reads.
     */
    private void showTerms() {
        dialogBuilder()
                .setTitle("Terms")
                .setMessage("PocketAgent is provided as it is, with no warranty of any kind. It is a "
                        ...
                        + "package in it stays under its own licence, and PocketAgent changes "
                        + "none of them.\n\n"
                        + "The AI apps are not PocketAgent's. Installing one downloads it from its "
                        ...
                        + "PocketAgent itself sends nothing anywhere. It has no account, no server "
                        ...
                        + "and where its source is. Removing PocketAgent removes the Linux "
    ...
    private void confirmBasicsUpdate() {
        ...
        if (!ContainerRuntime.basicsUpdateDue(this)) {
            showMessage("Already up to date", "The computer's basics were installed by this version "
                    + "of PocketAgent. This row comes back when a newer version has something to add.");
            return;
        }
    ...
    private void confirmRemove() {
        dialogBuilder()
                ...
                .setMessage("Deletes Ubuntu and everything inside it: the AI apps, their sign-ins and "
                        ...
                        + "or on the phone itself are not touched. PocketAgent stays installed, and "
    ...
    private AlertDialog.Builder dialogBuilder() {
        return new AlertDialog.Builder(this, dark
                ? R.style.Theme_PocketAgent_Legacy_Dialog
                : R.style.Theme_PocketAgent_Legacy_Dialog_Light);
    }
    ...
    private void showSafeScreen(Throwable error) {
        ...
        try {
            ...
            emergency.setText("PocketAgent safe mode\nPlease reinstall the latest APK.");
