...
public final class DesktopActivity extends Activity implements KeyboardInputView.Listener {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        try {
            ...
            audio.setSocketPath(new java.io.File(ContainerRuntime.rootfs(this),
                    "home/coder/.pocketagent/audio.sock").getAbsolutePath());
            audio.start();
     ...
     * thread: the phone would show "PocketAgent isn't responding" and might end the app in the
     * middle of the copy.
     */
     ...
     *
     * This asks the phone's OWN camera app to take it, so PocketAgent needs no camera permission
    ...
    private void showLaunchFailure(Throwable error) {
        ...
        try {
            ...
            back.setText("Back to PocketAgent");
    ...
    private View buildScreen() {
        ...
        home.setContentDescription("Back to PocketAgent home");
    ...
    private void showWindowMenu(View anchor) {
        ...
        menu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                // Super+A, Super+P and Super+R are set up by pocketagent-menu.
    ...
    private void showDetails() {
        ...
        String text = "Linux computer: Ubuntu 24.04 LTS on this phone's own processor, inside "
                ...
                + "there is no call, ring or alarm sound in PocketAgent at all. The phone's volume "
    ...
    private String vncSocketPath() {
        return new java.io.File(ContainerRuntime.rootfs(this), "home/coder/.pocketagent/vnc.sock")
                .getAbsolutePath();
    }
    ...
    private void startWindowResize() {
        ...
        // Un-maximise first: PocketAgent opens windows full-screen, and a maximised window
        // cannot be resized -- the drag would appear to do nothing at all.
        chord(0xffeb, 'u');                       // Super+U: pocketagent-windows unmaximise
        desktop.postDelayed(() -> {
    ...
    /**
     * The setting made in PocketAgent, applied to this screen -- and through it to the Linux
