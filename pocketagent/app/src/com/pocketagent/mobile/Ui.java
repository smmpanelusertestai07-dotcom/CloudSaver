...
final class Ui {
    ...
    static final int LIGHT_FIELD = Color.rgb(243, 241, 235);
    ...
    static final int DARK_FIELD = Color.rgb(37, 37, 37);

    // Brand
    static final int PRIMARY = LIGHT_TEXT;
    static final int PRIMARY_DEEP = DARK_BG;
    static final int PRIMARY_ON_DARK = DARK_TEXT;
    ...
    /** Legacy call name retained; native and advanced surfaces now use flat neutral fills. */
    static GradientDrawable glass(Context context, boolean dark, float radiusDp) {
        return background(surface(dark), radiusDp, context);
    }

    static GradientDrawable brandGradient(Context context, float radiusDp) {
        return background(PRIMARY, radiusDp, context);
    }
    ...
    static Drawable tappable(Context context, Drawable content, boolean dark) {
        int ripple = dark ? Color.argb(40, 255, 255, 255) : Color.argb(28, 0, 0, 0);
    ...
    static Button primaryButton(Context context, String label, int iconRes) {
        ...
        button.setBackground(tappable(context, background(PRIMARY, 12, context), true));
    ...
    static Button secondaryButton(Context context, String label, boolean dark, int iconRes) {
        ...
        button.setBackground(tappable(context,
                outlined(surface(dark), line(dark), 12, context), dark));
    ...
    static LinearLayout card(Context context, boolean dark) {
        ...
        card.setBackground(glass(context, dark, 14));
        card.setElevation(0);
