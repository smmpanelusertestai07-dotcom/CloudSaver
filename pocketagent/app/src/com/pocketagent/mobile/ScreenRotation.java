 ...
 * carries its own rotation setting: an owner who picked "Auto-rotate" in PocketAgent has said
...
final class ScreenRotation {
    ...
    /** The Android orientation for one of PocketAgent's three settings. */
